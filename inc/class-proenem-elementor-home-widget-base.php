...
abstract class Proenem_Elementor_Home_Widget_Base extends Proenem_Elementor_Sales_Widget_Base {
	...
	protected function home_primary_cta_label( $label ) {
		$legacy_labels = array(
			esc_html__( 'Começar grátis', 'proenem-wordpress-theme' ),
			esc_html__( 'Criar conta grátis', 'proenem-wordpress-theme' ),
		);

		return in_array( $label, $legacy_labels, true )
			? esc_html__( 'Conheça a Turma Intensiva', 'proenem-wordpress-theme' )
			: $label;
	}
...
class Proenem_Elementor_Home_Action_Bar_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->add_text_control( 'primary_button_label', esc_html__( 'Botão primário', 'proenem-wordpress-theme' ), esc_html__( 'Conheça a Turma Intensiva', 'proenem-wordpress-theme' ) );
		$this->add_url_control( 'primary_button_url', esc_html__( 'Link do botão primário', 'proenem-wordpress-theme' ), proenem_get_home_cta_destination( 'plans' ) );
		$this->end_controls_section();
	}
	...
	protected function render(): void {
		...
		<aside class="pen-hero-action-bar pro-home-hero-action-bar" aria-label="<?php esc_attr_e( 'Comece a estudar com o Método PRO', 'proenem-wordpress-theme' ); ?>">
			...
			<div class="pen-hero-action-bar__action pro-home-hero-action-bar__actions">
				<?php $this->render_home_button( 'primary_button_url', $this->home_cta_link( $settings['primary_button_url'] ?? array(), 'plans' ), $this->home_primary_cta_label( $settings['primary_button_label'] ?? '' ), 'pen-button pen-button--primary pen-button--md' ); ?>
			</div>
		</aside>
		<?php
		$this->close_home_wrapper();
...
class Proenem_Elementor_Home_Marquee_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->add_textarea_control( 'items', esc_html__( 'Frases, uma por linha', 'proenem-wordpress-theme' ), esc_html__( "Sua aprovação não é sorte. É método.\nEstude com estratégia, não com mais horas.\nConheça o Método PRO", 'proenem-wordpress-theme' ) );
		$this->end_controls_section();
	}
...
class Proenem_Elementor_Home_Pillars_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->add_text_control( 'button_label', esc_html__( 'Botão', 'proenem-wordpress-theme' ), esc_html__( 'Ver a Turma Intensiva', 'proenem-wordpress-theme' ) );
		$this->add_url_control( 'button_url', esc_html__( 'Link do botão', 'proenem-wordpress-theme' ), proenem_get_home_cta_destination( 'plans' ) );
			...
			array(
				...
				'default'     => array(
					array(
						...
						'body'   => esc_html__( 'Seu objetivo vira um plano claro, com prioridades e metas semanais. Você sabe exatamente o que estudar primeiro.', 'proenem-wordpress-theme' ),
						'tone'   => 'blue',
					...
					array(
						...
						'body'   => esc_html__( 'Simulados adaptativos mapeiam suas forças e lacunas. Você vê, com dados, onde está e o que rende mais nota agora.', 'proenem-wordpress-theme' ),
						'tone'   => 'featured',
					...
					array(
						...
						'body'   => esc_html__( 'O plano diz o que estudar, quando revisar e como corrigir a rota — sem você se perder no meio do caminho.', 'proenem-wordpress-theme' ),
						'tone'   => 'red',
...
class Proenem_Elementor_Home_Pain_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->add_text_control( 'title_line_1', esc_html__( 'Título linha 1', 'proenem-wordpress-theme' ), esc_html__( 'Estuda muito', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'title_emphasis_1', esc_html__( 'Destaque 1', 'proenem-wordpress-theme' ), esc_html__( 'e a nota', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'title_line_2', esc_html__( 'Título linha 2', 'proenem-wordpress-theme' ), esc_html__( 'não', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'title_emphasis_2', esc_html__( 'Destaque 2', 'proenem-wordpress-theme' ), esc_html__( 'sobe?', 'proenem-wordpress-theme' ) );
		...
		$this->add_text_control( 'button_badge', esc_html__( 'Badge do botão', 'proenem-wordpress-theme' ), esc_html__( '7 dias de garantia', 'proenem-wordpress-theme' ) );
		$this->add_url_control( 'button_url', esc_html__( 'Link do botão', 'proenem-wordpress-theme' ), proenem_get_home_cta_destination( 'plans' ) );
			...
			array(
				...
				'default'     => array(
					array(
						...
						'body'           => esc_html__( 'Cronograma bonito, mas sem prioridade. Você estuda tudo igual e o resultado não aparece.', 'proenem-wordpress-theme' ),
						'tone'           => 'blue',
					),
					array(
						'title_emphasis' => esc_html__( 'Trava', 'proenem-wordpress-theme' ),
						'title_suffix'   => esc_html__( 'em simulados', 'proenem-wordpress-theme' ),
						'body'           => esc_html__( 'A nota empaca. Você faz simulado, mas não analisa o erro — e repete o mesmo tropeço.', 'proenem-wordpress-theme' ),
						'tone'           => 'yellow',
					),
					array(
	...
	protected function render(): void {
		...
		<section class="pen-feature-grid-section" aria-labelledby="<?php echo esc_attr( $this->section_heading_id() ); ?>">
			...
			<?php $this->render_home_button( 'button_url', $this->home_cta_link( $settings['button_url'] ?? array(), 'plans' ), $settings['button_label'] ?? '', 'pen-button pen-button--primary pen-button--md pro-home-pain-section__cta', $settings['button_badge'] ?? '' ); ?>
...
class Proenem_Elementor_Home_Questions_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		...
		$this->add_text_control( 'button_label', esc_html__( 'Botão', 'proenem-wordpress-theme' ), esc_html__( 'Conheça a Turma Intensiva', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'button_badge', esc_html__( 'Badge do botão', 'proenem-wordpress-theme' ), esc_html__( 'Ver plano e preço', 'proenem-wordpress-theme' ) );
		$this->add_url_control( 'button_url', esc_html__( 'Link do botão', 'proenem-wordpress-theme' ), proenem_get_home_cta_destination( 'plans' ) );
	...
	protected function render(): void {
		...
		<section<?php echo '' !== $section_anchor ? ' id="' . esc_attr( $section_anchor ) . '"' : ''; ?> class="pen-question-bank-section" aria-labelledby="<?php echo esc_attr( $this->section_heading_id() ); ?>">
			...
			<?php $this->render_home_button( 'button_url', $this->home_cta_link( $settings['button_url'] ?? array(), 'plans' ), $settings['button_label'] ?? '', 'pen-button pen-button--secondary pen-button--sm pro-home-question-bank__cta', $settings['button_badge'] ?? '' ); ?>
...
class Proenem_Elementor_Home_Pricing_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function render(): void {
		...
		$default_plan_pricing   = array(
			esc_html__( 'Turma Intensiva 2026', 'proenem-wordpress-theme' ) => array(
				'legacy_price'        => '29',
				'price'               => '29,90',
				'price_prefix'        => esc_html__( '12x de R$', 'proenem-wordpress-theme' ),
				'price_details'       => esc_html__( 'ou R$ 306,90 à vista', 'proenem-wordpress-theme' ),
		...
		$unavailable_plan_names = array(
			esc_html__( 'Grátis', 'proenem-wordpress-theme' ),
		...
		<section<?php echo '' !== $section_anchor ? ' id="' . esc_attr( $section_anchor ) . '"' : ''; ?> class="pen-pricing-section" aria-labelledby="<?php echo esc_attr( $this->section_heading_id() ); ?>">
			...
			<div class="pen-plan-grid">
				<?php foreach ( (array) ( $settings['plans'] ?? array() ) as $index => $plan ) : ?>
					...
					if ( in_array( $plan_name, $unavailable_plan_names, true ) || ! empty( $plan['free'] ) ) {
						continue;
					}

					$summary           = $plan['summary'] ?? '';
					$features          = $plan['features'] ?? '';
					$is_intensive_plan = in_array( $plan_name, array( esc_html__( 'Método PRO', 'proenem-wordpress-theme' ), esc_html__( 'Turma Intensiva 2026', 'proenem-wordpress-theme' ) ), true );
...
class Proenem_Elementor_Home_Schools_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		$this->start_controls_section( 'content_section', array( 'label' => esc_html__( 'Conteúdo', 'proenem-wordpress-theme' ) ) );
		$this->add_textarea_control( 'marquee', esc_html__( 'Marquee, uma frase por linha', 'proenem-wordpress-theme' ), esc_html__( "Sua aprovação não é sorte. É método.\nEstude com estratégia, não com mais horas.\nConheça o Método PRO", 'proenem-wordpress-theme' ) );
		$this->add_home_media_control( 'primary_image', esc_html__( 'Imagem principal', 'proenem-wordpress-theme' ), 'student_school_1.webp' );
		$this->add_home_media_control( 'secondary_image', esc_html__( 'Imagem secundária', 'proenem-wordpress-theme' ), 'student_school_2.webp' );
...
class Proenem_Elementor_Home_Faq_Widget extends Proenem_Elementor_Home_Widget_Base {
	...
	protected function register_controls(): void {
		$this->start_controls_section( 'content_section', array( 'label' => esc_html__( 'Conteúdo', 'proenem-wordpress-theme' ) ) );
		$this->add_text_control( 'eyebrow', esc_html__( 'Selo', 'proenem-wordpress-theme' ), esc_html__( 'FAQ', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'title_line_1', esc_html__( 'Título linha 1', 'proenem-wordpress-theme' ), esc_html__( 'Perguntas', 'proenem-wordpress-theme' ) );
		$this->add_text_control( 'title_line_2', esc_html__( 'Título linha 2', 'proenem-wordpress-theme' ), esc_html__( 'frequentes', 'proenem-wordpress-theme' ) );
		$items = new \Elementor\Repeater();
		$items->add_control(
			'question',
			array(
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array(
						'question' => esc_html__( 'O que é a Turma Intensiva 2026?', 'proenem-wordpress-theme' ),
						'answer'   => esc_html__( 'Uma estrutura de preparação que combina meta, diagnóstico, execução e performance para organizar seus estudos e transformar esforço em nota.', 'proenem-wordpress-theme' ),
					),
					array(
						'question' => esc_html__( 'O que está incluído na Turma Intensiva?', 'proenem-wordpress-theme' ),
						'answer'   => esc_html__( 'Diagnóstico inicial, nota prevista, banco de mais de 60 mil questões, cronograma personalizado até a prova, duas correções de redação mensais, aulas gravadas, PDFs completos e simulados com nota TRI.', 'proenem-wordpress-theme' ),
					),
					array(
						'question' => esc_html__( 'Posso entrar em qualquer época do ano?', 'proenem-wordpress-theme' ),
						'answer'   => esc_html__( 'Pode. O diagnóstico inicial ajusta o plano ao seu momento e ao tempo até a prova.', 'proenem-wordpress-theme' ),
					),
					array(
	...
	protected function render(): void {
		...
		foreach ( (array) ( $settings['items'] ?? array() ) as $index => $item ) :
			...
			if ( in_array( $question, array( esc_html__( 'Posso começar de graça?', 'proenem-wordpress-theme' ), esc_html__( 'Qual a diferença entre os planos?', 'proenem-wordpress-theme' ) ), true ) ) {
				if ( esc_html__( 'Posso começar de graça?', 'proenem-wordpress-theme' ) === $question ) {
					continue;
				}
			...
			if ( esc_html__( 'O que é o Método PRO?', 'proenem-wordpress-theme' ) === $question ) {
				$question = esc_html__( 'O que é a Turma Intensiva 2026?', 'proenem-wordpress-theme' );
			}
			...
			?>
			<details class="pen-faq-item" <?php echo 1 === $index ? 'open' : ''; ?>><summary><?php echo esc_html( $question ); ?></summary><p><?php echo esc_html( $answer ); ?></p></details><?php endforeach; ?></div></section>
		<?php
		$this->close_home_wrapper();
	}
}
